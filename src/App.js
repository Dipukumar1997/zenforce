...
// // New Essential Pages for AdSense Approval
...
//   const hideNavPaths = ['/login', '/reset-password', '/email-verify'];
...
// function Footer() {
//   const location = useLocation();
//   const hideFooterPaths = ['/login', '/reset-password', '/email-verify'];
...
//               Your comprehensive platform for tools, news, and developer resources.
//             </p>
//           </div>
...
//               {/* <li><
//               Link to="/news" className="text-gray-400 hover:text-white transition">News Feed</Link></li> */}
...
//               Perform complex calculations with our advanced calculator tool. Support for scientific operations and more.
//             </p>
//             <button
...
//             <p className="text-gray-600 mb-4">
//               Stay updated with the latest news from around the world. Get real-time updates on topics that matter to you.
//             </p>
//             {/* <button
...
//             <p className="text-gray-600 mb-4">
//               Access powerful developer resources, code snippets, and notes. Perfect for developers on the go.
//             </p>
//             <button
...
function Navigation() {
  ...
  const hideNavPaths = ['/login', '/reset-password', '/email-verify', '/developer', '/developer/notes','/news','/cal'];
  if (hideNavPaths.includes(location.pathname)) return null;
...
function Footer() {
  ...
  const hideFooterPaths = ['/login', '/reset-password', '/email-verify', '/developer', '/developer/notes'];
  if (hideFooterPaths.includes(location.pathname)) return null;
